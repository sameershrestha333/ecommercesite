...
<div class="container-wrapper">
    ...
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/admin/product/updateProduct" method="post" commandName="product" enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <label class="checkbox-inline"><form:radiobutton path="productCondition" id="condition"
                                                             value="new"/>New</label>
            <label class="checkbox-inline"><form:radiobutton path="productCondition" id="old" value="new"/>Old</label>
        </div>
        <div class="form-group">
            <label for="status">Status</label>
            <label class="checkbox-inline"><form:radiobutton path="productStatus" id="condition"
                                                             value="active"/>Active</label> <label
                class="checkbox-inline"><form:radiobutton path="productStatus" id="condition"
